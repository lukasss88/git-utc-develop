(function ()
{
    ...
    function paginationSupport()
    {
        ...
        this.$get = ['$rootScope', 'AsyncQueue', function ($rootScope, AsyncQueue)
        {
            ...
            function AbstractPagination(context, refreshFunction, asyncQueueOptions)
            {
                ...
                context.filter[defaultConfig.maxResultsProperty] =
                        context.filter[defaultConfig.maxResultsProperty] || defaultConfig[defaultConfig.maxResultsProperty];
                ...
                {
                    var listener = defaultConfig.firstResultProperty === key ||
                            defaultConfig.maxResultsProperty === key ? modelListener : pageAwareModelListener;
    ...
    angular.module('utcApp').provider('paginationSupport', paginationSupport);
})();
